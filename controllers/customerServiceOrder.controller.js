...
const CustomerServiceOrder = db.CustomerServiceOrder;
...
class CustomerServiceOrderController extends BaseController {
  constructor() {
    super(CustomerServiceOrder, {
...
module.exports = new CustomerServiceOrderController();

...
const CustomerProductOrder = db.CustomerProductOrder;
...
class CustomerProductOrderController extends BaseController {
  constructor() {
    super(CustomerProductOrder, {
...
module.exports = new CustomerProductOrderController();
